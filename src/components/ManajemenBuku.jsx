    ...
    <div className="container mt-3">
      ...
      {form === "create" &&(
        <div id="formTambah">
          <h5>Tambah Buku</h5>
          <hr />
          <form action="" className="row form-row" onSubmit={submitAdd}>
            <div className="col-3">
      ...
      {form === "edit" && (
        <div id="formUbah">
          <h5>Ubah Buku</h5>
          <hr />
          <form action="" className="row form-row" onSubmit={submitChange}>
            <div className="col-3">
            ...
            <div className="col-2">
              <input type="submit" className="btn btn-primary ms-5" value="ubah" />
            </div>
          </form>
        </div>
      )}
